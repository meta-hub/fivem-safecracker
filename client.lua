--[[
mini@safe_cracking dial_turn_anti_fast
mini@safe_cracking dial_turn_anti_fast_1
mini@safe_cracking dial_turn_anti_fast_2
mini@safe_cracking dial_turn_anti_fast_3
mini@safe_cracking dial_turn_anti_normal
mini@safe_cracking dial_turn_anti_slow
mini@safe_cracking dial_turn_clock_fast
mini@safe_cracking dial_turn_clock_fast_1
mini@safe_cracking dial_turn_clock_fast_2
mini@safe_cracking dial_turn_clock_fast_3
mini@safe_cracking dial_turn_clock_normal
mini@safe_cracking dial_turn_clock_slow
mini@safe_cracking dial_turn_fail_1
mini@safe_cracking dial_turn_fail_2
mini@safe_cracking dial_turn_fail_3
mini@safe_cracking dial_turn_fail_4
mini@safe_cracking dial_turn_succeed_1
mini@safe_cracking dial_turn_succeed_2
mini@safe_cracking dial_turn_succeed_3
mini@safe_cracking dial_turn_succeed_4
mini@safe_cracking door_open_succeed_stand
mini@safe_cracking door_open_succeed_stand_safe
mini@safe_cracking door_open_succeed_stand_safedoor
mini@safe_cracking idle_base
mini@safe_cracking idle_heavy_breathe
mini@safe_cracking idle_look_around
mini@safe_cracking safe_closed_safe
...
local loadResources = function()
	...
	RequestStreamedTextureDict(Config.TextDict)
	while not HasStreamedTextureDictLoaded(Config.TextDict) do Wait(0); end
end

local unloadResources = function()
	RemoveAnimDict(Config.AnimDict)
	SetStreamedTextureDictAsNoLongerNeeded(Config.TextDict)
end

local closestSafe = function()
	local pos = GetEntityCoords(GetPlayerPed(-1))
	local hash = GetHashKey('v_ilev_gangsafedoor')
...
safeCracker.start = function(safe_object,pins,callback,rotate_door)
	safe_object = (safe_object or closestSafe())
	pins = (pins or 4)
	...
	while true do
		...
		for i=1,pins,1 do
			...
			DrawSprite(Config.TextDict,sprite, start + (i / 10),0.2, 0.04,ratio * 0.04, 0,	255,255,255,255)
		end

		DrawSprite(Config.TextDict,"Dial_BG", 0.5,0.8, 0.3,				ratio * 0.3, 							0,	255,255,255,255)
		DrawSprite(Config.TextDict,"Dial",    0.5,0.8, 0.3 * 0.5,	ratio * 0.3 * 0.5, -dialrot,	255,255,255,255)
